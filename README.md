...
```bash
yarn add @thorswap-lib/hdwallet-core
yarn add @thorswap-lib/hdwallet-keepkey-webusb
yarn add @thorswap-lib/hdwallet-trezor-connect
yarn add @thorswap-lib/hdwallet-ledger-webusb
```
...
```javascript
import { HDWallet } from "@thorswap-lib/hdwallet-core";
import { isKeepKey, KeepKeyHDWallet } from "@thorswap-lib/hdwallet-keepkey";
import { isLedger, LedgerHDWallet } from "@thorswap-lib/hdwallet-ledger";
import { isTrezor, TrezorHDWallet } from "@thorswap-lib/hdwallet-trezor";

import { WebUSBKeepKeyAdapter } from "@thorswap-lib/hdwallet-keepkey-webusb";
import { WebUSBLedgerAdapter } from "@thorswap-lib/hdwallet-ledger-webusb";
import { TrezorAdapter } from "@thorswap-lib/hdwallet-trezor-connect";
```
...
```javascript
import { Keyring } from "@thorswap-lib/hdwallet-core";
